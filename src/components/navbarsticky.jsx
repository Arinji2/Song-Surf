    ...
    <React.Fragment>
      <div
        className={`w-full h-[120px] bg-${
          scroll > 60 ? "[#262525]" : "black"
        } sticky top-0 transition-all ease-in-out duration-300 md:flex hidden flex-row items-center justify-between text-white font-bold z-50 `}
      >
